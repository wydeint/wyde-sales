...
export interface Totals {
  ...
  /** จำนวนบรรทัด */
  lines: number
  /** บรรทัดที่ลงยอดประมาณการณ์แล้ว — เหตุผลเดียวกับ actLines */
  estLines: number
  /**
   * บรรทัดที่ลงยอดจัดจ้างจริงแล้ว
   *
   * ต้องแยกจาก `lines` เพราะห้องที่ประมาณการณ์ไว้แล้วแต่ยังไม่ได้จ้างใครเลย
...
export type RoomCostStatus = 'ยังไม่ประมาณการณ์' | 'รอเปิด PO' | 'เปิด PO ครบ' | 'เกินกำหนด'
...
export function roomStatus(
  ...
  if (!items.length) return 'ยังไม่ประมาณการณ์'
...
export const ROOM_STATUS_CLASS: Record<RoomCostStatus, string> = {
  'ยังไม่ประมาณการณ์': 'badge badge-gray',
...
export interface PersonScore {
  ...
  est: number
  act: number
  /** ค่าเฉลี่ยความคลาดเคลื่อนของการประมาณการณ์ (%) — null เมื่อยังไม่มีฐานให้เทียบ */
   ...
   *
   * เป็น GP ฝั่ง**จัดจ้างจริง**อย่างเดียว ฝั่งประมาณการณ์ยังไม่ใส่ เพราะ 116 จาก
   * 139 ห้องยังไม่มีประมาณการณ์เลยสักบรรทัด ห้องพวกนั้นจะคิดออกมาเป็น GP 100%

    ...
    >
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-2xl font-semibold text-sm relative overflow-hidden group disabled:opacity-60"
          style={{
        ...
        >
          ...
          <span className="relative z-10">{loading ? 'กำลังเปิด...' : 'Sign in with Google'}</span>
        </button>
